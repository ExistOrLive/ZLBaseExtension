...
public typealias NSASCContainer = NSAttributedStringConvertibleContainer
...
public class NSAttributedStringConvertibleContainer: NSObject {
    ...
    public convenience init(_ convertibles: NSAttributedStringConvertible?...) {
        self.init(attributes: [:], convertibles: convertibles)
    }

}

public extension NSAttributedStringConvertibleContainer {
...
extension NSAttributedStringConvertibleContainer: NSAttributedStringConvertible {
    ...
    public func asMutableAttributedString() -> NSMutableAttributedString {
        ...
        str2.enumerateAttributes(in: NSRange(location: 0, length: str2.length), options: .reverse) { (attributes, range, _) in
